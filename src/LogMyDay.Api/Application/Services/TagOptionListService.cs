...
public class TagOptionListService : ITagOptionListService
{
    ...
    public async Task<IEnumerable<TagOptionListResponse>> GetAll(Guid userId)
    {
    ...
    public async Task<TagOptionListResponse> GetById(int id, Guid userId)
    {
    ...
    public async Task<int> Create(TagOptionListRequest request, Guid userId)
    {
    ...
    public async Task Update(int id, TagOptionListRequest request, Guid userId)
    {
        var list = await _context.TagOptionLists
            .Include(l => l.Options)
