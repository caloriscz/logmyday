...
public class NotificationsController : BaseApiController
{
    ...
    public async Task<ActionResult<IList<NotificationResponse>>> GetByTag(int tagId)
    {
        ...
        try
        {
            var notifications = await _notificationService.GetByTag(tagId, userId);
    ...
    public async Task<ActionResult<NotificationResponse>> GetById(int id)
    {
        ...
        try
        {
            var notification = await _notificationService.GetById(id, userId);
    ...
    public async Task<ActionResult<NotificationResponse>> Create(NotificationRequest request)
    {
        ...
        try
        {
            var created = await _notificationService.Create(request, userId);
    ...
    public async Task<ActionResult<NotificationResponse>> Update(int id, NotificationRequest request)
    {
        ...
        try
        {
            var updated = await _notificationService.Update(id, request, userId);
    ...
    public async Task<ActionResult<NotificationResponse>> RecordDelivery(int id, NotificationDeliveryRequest request)
    {
        ...
        try
        {
            var updated = await _notificationService.RecordDelivery(id, request, userId);
