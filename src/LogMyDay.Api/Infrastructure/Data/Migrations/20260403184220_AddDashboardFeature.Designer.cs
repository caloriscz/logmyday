...
namespace LogMyDay.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260403184220_AddDashboardFeature")]
    partial class AddDashboardFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogMyDay.Domain.Entities.Dashboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_LogMyDay_Dashboards_UserId");

                    b.ToTable("LogMyDay_Dashboards", (string)null);
                });

            modelBuilder.Entity("LogMyDay.Domain.Entities.DashboardPanel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("AggregationTypeId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("DashboardId")
                        .HasDatabaseName("IX_LogMyDay_DashboardPanels_DashboardId");

                    b.HasIndex("TagId");

                    b.ToTable("LogMyDay_DashboardPanels", (string)null);
                });
            ...
            modelBuilder.Entity("LogMyDay.Domain.Entities.DashboardPanel", b =>
                {
                    b.HasOne("LogMyDay.Domain.Entities.Dashboard", "Dashboard")
                        .WithMany("Panels")
