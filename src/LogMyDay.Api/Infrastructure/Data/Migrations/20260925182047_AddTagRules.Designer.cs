...
namespace LogMyDay.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260925182047_AddTagRules")]
    partial class AddTagRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogMyDay.Domain.Entities.TagRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TargetTagId")
                        .IsUnique()
                        .HasDatabaseName("IX_LogMyDay_TagRules_TargetTagId");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_LogMyDay_TagRules_UserId");

                    b.ToTable("LogMyDay_TagRules", (string)null);
                });

            modelBuilder.Entity("LogMyDay.Domain.Entities.TagRuleSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SourceTagId")
                        .HasDatabaseName("IX_LogMyDay_TagRuleSources_SourceTagId");

                    b.HasIndex("RuleId", "SourceTagId")
                        .IsUnique()
                        .HasDatabaseName("IX_LogMyDay_TagRuleSources_RuleId_SourceTagId");

                    b.ToTable("LogMyDay_TagRuleSources", (string)null);
                });
            ...
            modelBuilder.Entity("LogMyDay.Domain.Entities.Activity", b =>
                {
                    b.HasOne("LogMyDay.Domain.Entities.TagRule", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LogMyDay.Domain.Entities.TagRule", b =>
                {
                    b.HasOne("LogMyDay.Domain.Entities.Tag", "TargetTag")
                        .WithMany()
            ...
            modelBuilder.Entity("LogMyDay.Domain.Entities.TagRuleSource", b =>
                {
                    b.HasOne("LogMyDay.Domain.Entities.TagRule", "Rule")
                        .WithMany("Sources")
                        .HasForeignKey("RuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LogMyDay.Domain.Entities.Tag", "SourceTag")
                        .WithMany()
