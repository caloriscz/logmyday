...
public interface IExcelExportService
{
    ...
    Task<ExcelExportResult> GenerateExcelReportAsync(ExcelExportRequest request);
    ...
    Task<List<TagResponse>> GetAvailableTagsAsync(Guid? userId = null);
    ...
    Task<ExcelExportStatistics> GetExportPreviewAsync(ExcelExportRequest request);
}
