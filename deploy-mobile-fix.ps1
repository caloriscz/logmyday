...
Write-Host "• From command line: dotnet build LogMyDay.App.Mobile/LogMyDay.App.Mobile.csproj -t:Run -f net9.0-android" -ForegroundColor Gray
Write-Host ""
...
Write-Host ""
Write-Host "Full documentation: .github/instructions/mobile-css-root-cause-fix.md" -ForegroundColor Gray
